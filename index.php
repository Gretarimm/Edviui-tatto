...
<body>
	<header>
		<nav>
			<ul id="ulfirst">
				<li><a class="btnfirst" href="#second">Meistrai</a></li>
				<li><a class="btnfirst" href="#third">Galerija</a></li>
				<li><a class="btnfirst" href="#forth">Kontaktai</a></li>
				<ul id="ulsecond">
					<li><a class="btnsecond activesecond" href="index.php">Lt</a></li>
